...
#dt = arange(1e-4, 1e-3, 1e-4)
dt = arange(1e-2, 1e-1, 1e-2)

def loop(j):

  dirResults="./results_dt_" + str(int(1000*dt[j])) + "/"
  ...
  setParameter("timeStep", dt[j], dataFile) 
  setParameter("nbIterations", 2.0/dt[j], dataFile) 
