...
nu=random.uniform(0.4, 0.49, nbSimulations)
csf_pressure=random.uniform(1e4, 1e5, nbSimulations)
print("# simulations: " + str(nbSimulations))

def loop(j):

  dirResults="./brain_training/sim" + wildcard(j) + "/"
  ...
  setParameter("csf_pressure", csf_pressure[j], dataFile) 
