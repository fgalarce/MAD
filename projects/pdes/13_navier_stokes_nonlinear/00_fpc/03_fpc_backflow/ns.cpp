...
//  io.writeState(geo.boundaryLabelFunction(), "indicatrixBD", 0);
//
//  /* initial condition */
...
////  if (par.initial_condition_pre() != "none" && par.initial_condition_vel() != "none"){
//    Vec u0 = zeros(nbDofs);
//    vector<string> init_cond(3);
//    init_cond[0] = "./init_condition/ux.09999.scl";
//    init_cond[1] = "./init_condition/uy.09999.scl";
//    init_cond[2] = "./init_condition/p.09999.scl";
////    io.loadVector(u0, par.initial_condition_vel(), par.initial_condition_pre());
...
//    ns.setInitialCondition(u0);
  ...
  FPC fluid;
  fluid.initialize(io, boundary, geo, par, calculus);
