...
def loop(j):
  ...
  for i in range(nbMeshes):
    ...
    call("cp distance_parameters " + dataFile, shell=True)
    ...
    templateModel="../../data/venturi/mor/mesh" + wildcard(i) + "/"
    ...
    if n_procs == 1:
        cmd = "./training_distance.exe " + dataFile + " " + str(j) + " " + str(i)
    else:
        cmd = "./training_distance.exe " + dataFile + " " + str(j) + " " + str(i) + " > " + dirResults + "/distance_october.log"
