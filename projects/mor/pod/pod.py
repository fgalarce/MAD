...
def loop(i):
  ...
  maniFolder="../../../../data/fpc/geo" + wildcard(i) + "/"
  geometryData="../../../../data/mesh/fpc/fpc." + wildcard(i) + ".mesh"
  dirResults="../../../../data/fpc/geo" + wildcard(i) + "/pod/"

  call("mkdir -p " + dirResults, shell=True)
  dataFile = dirResults + "parameters"
  call("cp par_fpc " + dataFile, shell=True)
  ...
  if n_procs == 1:
      ...
      cmd = mpi + " -np 5 ./pod.exe " + dataFile + " > " + dirResults + "/pod.log"
