  ...
  for i in sims:
    for k in range(10,60,10):
      for noise_level in noise:
        ...
        dirResults="../../data/reconstruction/u_H1/noise/sim" + wildcard(i) + "/" + str(k) + "modes/noise_" + str(int(noise_level)) + "_it" + str(j) + "/"
      
        call("mkdir -p " + dirResults, shell=True)
        dataFile = dirResults + "data"
        call("cp data_free_coef " + dataFile, shell=True)
