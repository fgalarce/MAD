...
def loop(j):
  ...
  dirResults="../../data/mesh/venturi/discretization_matrix/H1_mats" + wildcard(j) + "/"
  ...
  setParameter("geometryData", "../../data/mesh/venturi/venturi" + wildcard(j) + ".mesh", dataFile) 
  
  if n_procs == 1:
      cmd = "./assemble.exe " + dataFile
  else:
      cmd = "./assemble.exe " + dataFile + " > " + dirResults + "/assemble.log"
